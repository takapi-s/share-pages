...
export function createApp(options = {}) {
  ...
  return createServer(async (req, res) => {
    ...
    if (pageMatch) {
      ...
      send(200, pageShell(page, `/p/${page.id}/content`, page.mime), { 'content-security-policy': "default-src 'self'; frame-src 'self'; script-src 'unsafe-inline' https://cdnjs.cloudflare.com; style-src 'unsafe-inline' https://cdnjs.cloudflare.com;" });
      return;
    }
