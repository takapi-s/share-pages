...
function pageShell(page, contentUrl, contentType) {
  ...
  return `<!doctype html><html lang="ja"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${title}</title><meta property="og:title" content="${title}"><meta property="og:description" content="${escapeHtml(description)}"><meta name="description" content="${escapeHtml(description)}"><style>:root{color-scheme:light}*{box-sizing:border-box}body{font-family:system-ui,sans-serif;margin:0;color:#222}header{display:flex;align-items:center;justify-content:space-between;gap:1rem;max-width:1100px;margin:0 auto;padding:1rem; border-bottom:1px solid #ddd}.brand{font-weight:700;color:inherit;text-decoration:none}.meta{color:#666;font-size:.9rem;margin:0}.tools{display:flex;align-items:center;gap:1rem}.download{color:inherit}.content{max-width:1100px;margin:0 auto;padding:2rem 1rem;line-height:1.7}iframe{display:block;width:100%;min-height:calc(100vh - 120px);border:0}code{background:#f3f3f3;padding:.1em .3em;border-radius:4px}@media(max-width:600px){header{align-items:flex-start;flex-direction:column}.tools{width:100%;justify-content:space-between}.content{padding-top:1.25rem}}</style></head><body><header><a class="brand" href="/">share-pages</a><div class="tools"><p class="meta">${escapeHtml(description)}</p><a class="download" href="/p/${page.id}/download">元ファイルをダウンロード</a></div></header><main class="content">${contentType === 'text/html' ? `<iframe sandbox="" src="${contentUrl}" title="${title}"></iframe>` : `<article>${page.rendered}</article>`}</main></body></html>`;
}
